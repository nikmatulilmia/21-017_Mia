...
public class MainActivity extends AppCompatActivity {
    ...
    private void initItemsData() {
        ...
        items.add(new Item(R.drawable.lisa, "LALISA", 20, 33));
        items.add(new Item(R.drawable.jennie, "JENNIE", 10, 54));
        items.add(new Item(R.drawable.rose, "ROSE", 27, 20));
        items.add(new Item(R.drawable.jisoo, "JISOO", 45, 67));
    }
